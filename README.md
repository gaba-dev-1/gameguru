...
```bash
# Download latest
curl -L github.com/gaba-dev-1/gameguru/releases/latest/download/gameguru.exe -o gameguru.exe
...
[![Download](https://img.shields.io/badge/Download-1e1b4b?style=for-the-badge&logo=download&logoColor=white)](https://github.com/gaba-dev-1/gameguru/releases)
